...
805 MB root-level devuan.ext2 entry. Current Xromwell builds cache lazy FATX
chain-map reads in 4 KiB pages, including 1 KiB-cluster E: partitions whose
table is about 1.25 MiB.
...
Notes:
  ...
  - The expected Xromwell banner revision for this package is 62835f4 or newer.
