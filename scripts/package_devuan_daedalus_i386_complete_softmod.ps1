...
& $packager `
    -OutDir (Join-Path $OutRoot 'xromwell-hddfatx-devuan-daedalus-i386-complete') `
    ...
    -InitrdName 'devinit' `
    -PayloadPath 'artifacts\hdd\xbox-devuan-daedalus-i386-complete.ext2' `
    ...
    -PackageTitle 'Xromwell FATX Devuan Daedalus i386 Complete Desktop Test' `
    -DashboardFolder 'XromwellDevuanDaedalusComplete'
