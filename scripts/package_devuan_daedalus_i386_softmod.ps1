...
& $packager `
    -OutDir (Join-Path $OutRoot 'xromwell-hddfatx-devuan-daedalus-i386-terminal') `
    ...
    -PackageTitle 'Xromwell FATX Devuan Daedalus i386 Terminal Test' `
    -DashboardFolder 'XromwellDevuanDaedalusTerminal'
