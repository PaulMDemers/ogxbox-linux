...
$config = Join-Path $repoRoot 'run\xemu-cromwell-modernhdr-busybox-reboot-probe-6.18.33.toml'
$mcpx = Join-Path $repoRoot 'Xbox-Emulator-Files\mcpx\mcpx_1.0.bin'
$bios = Join-Path $repoRoot 'artifacts\cromwell-autocd-modernhdr_1024.bin'
