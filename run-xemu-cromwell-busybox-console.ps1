...
$config = Join-Path $repoRoot 'run\xemu-cromwell-busybox-console.toml'
$mcpx = Join-Path $repoRoot 'Xbox-Emulator-Files\mcpx\mcpx_1.0.bin'
$bios = Join-Path $repoRoot 'artifacts\cromwell-fast-atapi_1024.bin'
$iso = Join-Path $repoRoot 'artifacts\cromwell-busybox-console.iso'
